...
class ArcLayer: CAShapeLayer {
    ...
    override init() {
        super.init()
        fillColor = Colors.altBlue.CGColor
    ...
    var arcPathPre: UIBezierPath {
        ...
        arcPath.addLineToPoint(CGPoint(x: 0.0, y: 105.0))
        arcPath.addLineToPoint(CGPoint(x: 100.0, y: 105.0))
    ...
    var arcPathComplete: UIBezierPath {
        let arcPath = UIBezierPath()
        arcPath.moveToPoint(CGPoint(x: 0.0, y: 100.0))
        arcPath.addLineToPoint(CGPoint(x: 0.0, y: -3.0))
        arcPath.addLineToPoint(CGPoint(x: 100.0, y: -3.0))
        arcPath.addLineToPoint(CGPoint(x: 100.0, y: 100.0))
        arcPath.addLineToPoint(CGPoint(x: 0.0, y: 100.0))
        arcPath.closePath()
        return arcPath
